...
#define M_HEADER_MATRIX(TYPE, N, POSTFIX) \
  typedef struct M_PASTE(mMatrix, POSTFIX) { TYPE i[N][N]; } M_PASTE(mMatrix, POSTFIX);

#define M_SOURCE_MATRIX(TYPE, N, POSTFIX) \
                                          \
  M_SCOPE \
  M_PASTE(mMatrix, POSTFIX) M_PASTE(mAdd_M, POSTFIX) ( \
    M_PASTE(mMatrix, POSTFIX) a, \
    M_PASTE(mMatrix, POSTFIX) b \
  ) { \
      \
    M_PASTE(mMatrix, POSTFIX) result; \
    for (int i = 0; i < N; i++) { \
    for (int j = 0; j < N; j++) { \
    ...
    \
  M_SCOPE \
  M_PASTE(mMatrix, POSTFIX) M_PASTE(mSub_M, POSTFIX) ( \
    M_PASTE(mMatrix, POSTFIX) a, \
    M_PASTE(mMatrix, POSTFIX) b \
  ) { \
      \
    ...
    \
  M_SCOPE \
  M_PASTE(mMatrix, POSTFIX) M_PASTE(mMul_M, POSTFIX) ( \
    M_PASTE(mMatrix, POSTFIX) a, \
    M_PASTE(mMatrix, POSTFIX) b \
  ) { \
      \
    ...
    \
  M_SCOPE \
  M_PASTE(mVector, POSTFIX) M_PASTE3(mMul_M, POSTFIX, M_PASTE(_V,POSTFIX)) ( \
    M_PASTE(mMatrix,POSTFIX) a, \
    ...
    \
  M_SCOPE \
  M_PASTE(mMatrix, POSTFIX) M_PASTE3(mMul_f, POSTFIX, M_PASTE(_M,POSTFIX)) ( \
    float a, \
    M_PASTE(mMatrix,POSTFIX) b \
  ) { \
      \
    ...
    \
  M_SCOPE \
  M_PASTE(mVector,POSTFIX) M_PASTE(mGet_Col_M, POSTFIX) ( \
    int n, \
    M_PASTE(mMatrix,POSTFIX) m \
  ) { \
      \
    M_PASTE(mVector,POSTFIX) result; \
    for (int i = 0; i < N; i++) { \
  ...
  \
  M_SCOPE \
  M_PASTE(mVector,POSTFIX) M_PASTE(mGet_Row_M, POSTFIX) ( \
    int n, \
    M_PASTE(mMatrix,POSTFIX) m \
  ) { \
      \
