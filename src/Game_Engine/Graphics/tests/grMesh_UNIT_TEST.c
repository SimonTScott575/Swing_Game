...
int main() {
  ...
  float* mesh_vertices = mesh->vertices_data;
  int32_t* mesh_indices = mesh->indices;
  uint64_t mesh_size_of_vertex = mesh->size_of_vertex;
  uint64_t mesh_vertices_count = mesh->vertices_data_length;
  uint64_t mesh_indices_count = mesh->indices_length;
