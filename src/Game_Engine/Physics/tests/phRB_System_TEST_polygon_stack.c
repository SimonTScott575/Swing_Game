...
int main() {
  ...
  mFrame2D frame2 = init_mFrame2D(mMul_f_V2f( 0, mVector2f_Y), 0, mMul_f_V2f(0.1, mVector2f_ONE));
  mFrame2D frame3 = init_mFrame2D(mMul_f_V2f( 1, mVector2f_Y), 0, mMul_f_V2f(0.2, mVector2f_ONE));
  ...
  phCollider2D* collider1 = new_phCollider2D_POLYGON(&frame1, vertices, 4);
  phCollider2D* collider2 = new_phCollider2D_POLYGON(&frame2, vertices, 4);
  phCollider2D* collider3 = new_phCollider2D_POLYGON(&frame3, vertices, 4);
  ...
  phRigid_Body2D rb3 = init_phRigid_Body2D(&frame3, 4, 2/12.0f*(0.2*0.2*2), collider3);
  ...
  rb_sys->global_force = (mVector2f){{0,-0.1}};
