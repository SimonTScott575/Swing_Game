...
int main() {
  ...
  mFrame2D frame2 = init_mFrame2D(mMul_f_V2f(-1, mVector2f_X), 0, mMul_f_V2f(0.4, mVector2f_ONE));
  mFrame2D frame3 = init_mFrame2D(mMul_f_V2f( 1, mVector2f_X), 0, mMul_f_V2f(0.4, mVector2f_ONE));
